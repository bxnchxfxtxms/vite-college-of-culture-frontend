  ...
  render() {
    return (
			<div id="wrapper" className="clearfix">
				<script src="../../vendor/pupa.js" />
				<script src='../../vendor/js/functions.js' />
				<script src='../../vendor/js/jquery.js' />
				<script src='../../vendor/js/plugins.min.js' />
			{/* <Helmet> */}
				{/* <script src="../../vendor/pupa.js"></script> */}
			...
			{/* </Helmet> */}
					...
					<div id="header-wrap">
						<div className="container">
							<div className="header-row">
								<div id="logo">
									<a href="index.html" className="standard-logo" data-dark-logo="images/logo-dark.png"><Logo /></a>
									<a href="index.html" className="retina-logo" data-dark-logo="images/logo-dark@2x.png"><Logo /></a>
								</div>
								...
								<nav className="primary-menu">
									<ul className="menu-container">
										<li className="menu-item">
											<a className="menu-link" href="index.html"><div>Домой</div></a>
								...
								{/* <form className="top-search-form" action="search.html" method="get">
									<input type="text" name="q" className="form-control" defaultValue="" placeholder="Type &amp; Hit Enter.." autoComplete="off"></input>
								</form> */}
							</div>
						</div>
					</div>
				...
				<section id="slider" className="slider-element slider-parallax swiper_wrapper min-vh-60 min-vh-md-100">
					...
					<Helmet>
						...
						{/* <script src='/src/vendor/js/plugins.mins.js' /> */}
					</Helmet>
				</section>
