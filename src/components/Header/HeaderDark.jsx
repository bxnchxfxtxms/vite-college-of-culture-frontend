...
class HeaderDark extends React.Component {
					...
					<div id="header-wrap">
						<div className="container">
							<div className="header-row">
								<div id="logo">
									<a href="index.html" className="standard-logo"><Logo /></a>
									<a href="index.html" className="retina-logo"><Logo /></a>
								</div>
								...
								<nav className="primary-menu">
									<ul className="menu-container">
										<li className="menu-item">
											<a className="menu-link" href="/"><div>Главная</div></a>
										...
										<li className="menu-item">
											<a className="menu-link" href="/"><div>Абитуриентам</div></a>
											<ul className="sub-menu-container">
												<li className="menu-item">
													<a className="menu-link" href="/InfoForApplicants"><div>Информация о приёме</div></a>
												</li>
												<li className="menu-item">
													<a className="menu-link" href="intro.html#section-onepage"><div>Специальности</div></a>
												</li>
												<li className="menu-item">
													<a className="menu-link" href="/ApplicationRules"><div>Правила приёма</div></a>
												</li>
												{/* <li className="menu-item">
													<a className="menu-link" href="index-corporate.html"><div>Home - Corporate</div></a>
													<ul className="sub-menu-container">
										...
										<li className="menu-item">
											<a className="menu-link" href='/students' to='/students'><div>Студентам</div></a>
											<ul className="sub-menu-container">
												<li className="menu-item">
										...
										{/* <li className="menu-item mega-menu">
											<a className="menu-link" href="#"><div>Колледж</div></a>
											<div className="mega-menu-content mega-menu-style-2">
												<div className="container">
													<div className="row">
														<ul className="sub-menu-container mega-menu-column col-lg-5">
															<li className="menu-item mega-menu-title">
																<a className="menu-link" href="#"><div>О колледже</div></a>
																<ul className="sub-menu-container">
																	<li className="menu-item">
																		...
																		<ul className="sub-menu-container mega-menu-dropdown">
																			...
																			<li className="menu-item">
																				<a className="menu-link" href="/Structure">
																					<div>
											...
											<div className="mega-menu-content mega-menu-style-2">
												<div className="container">
													<div className="row">
														<ul className="sub-menu-container mega-menu-column col-lg-5">
															<li className="menu-item mega-menu-title">
																<a className="menu-link" href="#"><div>Сведения об образовательной организации</div></a>
																<ul className="sub-menu-container">
																	<li className="menu-item">
																		<a className="menu-link" href="/BasicInfo">
																			<div>
																				Основные сведения
																			</div>
																		</a>
																	...
																	<li className="menu-item">
																		<a className="menu-link" href="portfolio-1.html">
																			<div>
																				Документы
																			</div>
																		</a>
																	...
																	<li className="menu-item">
																		<a className="menu-link" href="portfolio-1.html">
																			<div>
																				Материально-технической обеспечение и 
																	...
																	<li className="menu-item">
																		<a className="menu-link" href="portfolio-1.html">
																			<div>
																				Финансово-хозяйственная деятельност
																			</div>
																		</a>
																	</li>
																	<li className="menu-item">
																		<a className="menu-link" href="/Vacancy">
																			<div>
				...
				{/* <section id="content">
					<div className="content-wrap">
						...
						<div id="oc-clients-full" className="owl-carousel image-carousel carousel-widget" data-margin="30" data-nav="false" data-loop="true" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
							...
							<a href="#"><img src="images/clients/1.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/2.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/3.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/4.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/5.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/6.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/7.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/8.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/9.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/10.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/11.png" alt="Clients"></img></a>
							<a href="#"><img src="images/clients/12.png" alt="Clients"></img></a>
